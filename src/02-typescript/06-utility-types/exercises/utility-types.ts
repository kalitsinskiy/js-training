...
console.log('Search first param:', param);
console.log('Search result type:', result);
console.log('Loaded result type:', loaded);
...
type E = MyRecord<'admin' | 'editor', string[]>; // { admin: string[]; editor: string[] }
