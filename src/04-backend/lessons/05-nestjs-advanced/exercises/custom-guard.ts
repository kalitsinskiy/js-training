...
// ============================================
// Run: npx ts-node src/04-backend/lessons/05-nestjs-advanced/exercises/custom-guard.ts
//
...
void Controller; void Get; void Module; void Injectable; void UseGuards; void SetMetadata;
void (undefined as unknown as CanActivate); void (undefined as unknown as ExecutionContext);
void ForbiddenException; void Reflector; void NestFactory; void FastifyAdapter;
...
void ROLES_KEY; // Will be used in your Roles decorator and RolesGuard
