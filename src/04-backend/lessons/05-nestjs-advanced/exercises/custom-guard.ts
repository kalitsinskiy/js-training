...
async function bootstrap() {
  ...
  console.log('curl -H "x-user-role: viewer" http://localhost:3000/dashboard/stats');
  console.log('curl -H "x-user-role: viewer" http://localhost:3000/dashboard/settings');
  console.log('curl -H "x-user-role: admin" http://localhost:3000/dashboard/settings');
}
