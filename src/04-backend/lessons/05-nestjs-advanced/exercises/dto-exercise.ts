...
// DTO EXERCISE
// ============================================
// Run: npx ts-node src/04-backend/lessons/05-nestjs-advanced/exercises/dto-exercise.ts
//
...
void Controller; void Get; void Post; void Put; void Param; void Body; void Module; void Injectable;
void ValidationPipe; void NestFactory; void FastifyAdapter;
void (undefined as unknown as NestFastifyApplication);
void IsString; void IsOptional; void IsEnum; void MinLength; void MaxLength;
void IsArray; void ArrayMinSize; void IsUUID; void IsDateString; void ValidateNested;
void Type;
...
void TasksService; // Will be used when you implement the controller
