...
// ============================================
// Run: npx ts-node src/04-backend/lessons/06-validation-and-error-handling/exercises/error-handler.ts
//
...
//   curl -X POST http://localhost:3000/items/1/validate                                                                # 400 — custom
