...
console.log(composed(5)); //should return 144 // 1) (5 + 1) * 2 = 12. 2) 12 * 12 = 144
...
// Test it (uncomment):
const debouncedLog2 = debounce((msg) => console.log('Logged:', msg), 1000);
debouncedLog2('First');
debouncedLog2('Second');
debouncedLog2('Third'); // Only this should execute after 1 second
...
console.time('first');
fastFib(40); // first: 1.063s
console.timeEnd('first');

console.time('second');
fastFib(40); // second: 0.01ms
console.timeEnd('second');

console.time('third');
fastFib(37); // third: 299.11ms
console.timeEnd('third');

console.time('fourth');
fastFib(37); // fourth: 0.007ms
